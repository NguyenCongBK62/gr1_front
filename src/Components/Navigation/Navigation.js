        ...
        <Menu style={{width: '200px', marginTop: '20px', marginLeft: '-20px'}}>
            <SubMenu title="sub menu">
                <div style={{width: '400px', height: 'auto'}}>
                    <Row>
                        <Col span={12} style={{textAlign: 'center'}}>Java</Col>
                        <Col span={12} style={{textAlign: 'center'}}>Ruby</Col>
                    </Row>
                </div>
            </SubMenu>
            <SubMenu title="sub menu">
            ...
            <Menu theme="dark" mode="horizontal" className='header-menu' >
                <Menu.Item>
                    <Dropdown overlay={menuJob}>
                        <Link to='/jobs' className="ant-dropdown-link" id='dropdown-link-navi'>
                            Việc Làm IT
                        </Link>
                    </Dropdown>
                </Menu.Item>
                <Menu.Item >
                    <Dropdown overlay={menuCompany}>
                        <a className="ant-dropdown-link" id='dropdown-link-navi' onClick={e => e.preventDefault()}>
                            Công ty hàng đầu
                        </a>
                    </Dropdown>
                </Menu.Item>
                <Menu.Item id='header-item-right'>Nhà tuyển dụng</Menu.Item>
                <Menu.Item id='switch' ><Switch checkedChildren="VI" unCheckedChildren="EN" defaultChecked style={{backgroundColor: '#1890ff'}}/></Menu.Item>
                {
                    localStorage.getItem('Authorization')
                    ? <Menu.Item id='header-item-right-is-login' onClick={logoutHandle}>{localStorage.getItem('userName')}</Menu.Item>
                    : <Menu.Item id='header-item-right'><Link to='/signin' style={{color: 'white'}}>Đăng nhập</Link></Menu.Item>
                }
